...
#define STRING_CONFIG_H_AUTHOR "(Jason Whitman, Anet A8 Config)" // Who made the changes.
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 4.6     // Z offset: -below +above  [the nozzle] // + means nozzle prints higher, - means nozzle prints lower
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - 5.5)
  //#define FRONT_PROBE_BED_POSITION MIN_PROBE_EDGE
  #define BACK_PROBE_BED_POSITION (Y_BED_SIZE - 55)
